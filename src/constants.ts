...
export const ALL_EXPERIENCES: ExperienceType[] = [
  {
    ...
    processImage: "/experience/process.grainstaqe.webp",
    previewImage: "/experience/preview.grainstaqe.webp",
...
export const ALL_COLLABORATIONS: CollaborationType[] = [
  ...
  // },
  {
    ...
    impressionImgMd: "/collaboration/afordin-md.webp",
    impressionImgSm: "/collaboration/afordin-sm.webp",
  },
  // {
...
export const ALL_CASE_STUDIES: CaseStudyType[] = [
  {
    ...
    logo: "/case-study/WorkoutTracker.webp",
    description: { es: "", en: "" },
    technologies: [""],
  ...
  },
  {
    ...
    logo: "/case-study/ChuckNorrisJoke.webp",
    description: { es: "", en: "" },
    technologies: [""],
  ...
  {
    name: "Diet Pixie",
    logo: "/case-study/DietPixie.webp",
    description: { es: "", en: "" },
    technologies: [""],
